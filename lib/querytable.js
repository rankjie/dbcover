...
var Q, QueryTable, logger, prefix, replace_char, sqlbuilder, toType, _;
...
QueryTable = (function() {
  function QueryTable(table, db, cache, model, nameToField, ttl) {
    this.db = db;
    this.cache = cache;
    this.table = table;
  ...
  QueryTable.prototype.update = function(obj) {
    var deferred, field, k, name, _i, _j, _len, _len1, _ref, _ref1, _ref2;
  ...
  QueryTable.prototype["delete"] = function(obj) {
    var deferred, k, name, _i, _j, _len, _len1, _ref, _ref1;
          ...
          if (_.isEmpty(data) || (data.$family != null)) {
            return self.db.query(sql, (_ref = self._condition) != null ? _ref : self._args, function(err, rows) {
              ...
              if (err != null) {
                ...
                if (rows.length > 0) {
                  self.cache.set(cacheKey, JSON.stringify(rows), self.ttl, function(err, response) {
                  ...
                  for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
                    obj = _ref1[_i];
                    _results.push(self.cache.set(self.cacheKey(obj), JSON.stringify(self.cacheDate(obj)), self.ttl));
                  }
                  return _results;
                } else {
                  return deferred.resolve(dbToInstance(rows));
