...
QueryTable = (function() {
  ...
  QueryTable.prototype.count = function() {
    var defer, sql;
    sql = "SELECT COUNT('" + this.nameToField[Object.keys(this.nameToField)[0]]['column'] + "') AS count FROM " + this.table;
    defer = Q.defer();
  ...
  QueryTable.prototype.query = function() {
    ...
    cacheToInstance = function(rows) {
      ...
      this.debug('[dbcover] Found data in cache.');
      instances = [];
    ...
    dbToInstance = function(rows) {
      ...
      this.debug('[dbcover] Load data from DB.');
      instances = [];
