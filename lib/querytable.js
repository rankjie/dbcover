...
QueryTable = (function() {
  ...
  QueryTable.prototype.toSQL = function() {
    var columnName, f, field, i, k, name, operator, operators, opkey, sql, str, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
    ...
    if (this._condition != null) {
      for (i = _n = 0, _ref7 = sql.match(/\?/g).length; _n < _ref7; i = _n += 1) {
        ...
        if (_.isEmpty(data) || (data.$family != null)) {
          ...
          return self.db.query(sql, function(err, rows) {
            if (err != null) {
              ...
              return self.cache.set(cacheKey, JSON.stringify(rows), defaultTTL, function(err, response) {
                console.log('写入cache');
