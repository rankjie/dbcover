  ...
  QueryTable.prototype.query = function() {
              ...
              if (err != null) {
                ...
                if (rows.length > 0) {
                  ...
                  for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
                    obj = _ref1[_i];
                    _results.push(self.cache.set(self.cacheKey(obj), JSON.stringify(self.cacheDate(obj)), defaultTTL));
                  }
                  return _results;
                } else {
                  return deferred.resolve(dbToInstance(rows));
    ...
    if (self._queryType === 'insert') {
      self.db.query(sql, function(err, rows) {
        ...
        if (self.cache) {
          return self.cache.set(self.cacheKey(self._objToSave), JSON.stringify(self._cacheData), defaultTTL, function(err, response) {
            if (err != null) {
