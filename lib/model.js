...
var EmailValidator, Instance, IntegerValidator, Model, Observe, QueryTable, StringValidator, Validator, cache, cacheGroup, createField, db, repoGroup, toType, _, _ref;
...
_ref = require('./validators'), Validator = _ref.Validator, StringValidator = _ref.StringValidator, IntegerValidator = _ref.IntegerValidator, EmailValidator = _ref.EmailValidator;
...
Model = (function() {
  function Model(dataDefine) {
    var body, capitaliseFirstLetter, f, k, key, keyName, name, self, v, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
