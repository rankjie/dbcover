...
Model = (function() {
  function Model(dataDefine) {
    var body, f, k, key, keyName, name, primkeys, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _ref5;
    ...
    for (_l = 0, _len3 = primkeys.length; _l < _len3; _l++) {
      key = primkeys[_l];
      Model.prototype['findBy_' + key.name] = function(values) {
        var sqlStr, _len4, _m, _ref6;
        sqlStr = [];
        _ref6 = key.keyName;
        ...
        return this.find(sqlStr.join(' AND '));
      };
    }
  }
