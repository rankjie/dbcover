...
Model = (function() {
  function Model(dataDefine) {
    var body, capitaliseFirstLetter, f, k, key, keyName, name, self, temp, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    for (_l = 0, _len3 = _ref6.length; _l < _len3; _l++) {
      key = _ref6[_l];
      temp = _.cloneDeep(key);
      console.log('创建findby：' + JSON.stringify(temp));
      Model.prototype['findBy' + capitaliseFirstLetter(temp.name)] = function(values) {
        return console.log(temp.name);
      };
    }
  }
