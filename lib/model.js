...
var EmailValidator, Instance, IntegerValidator, Model, Observe, QueryTable, StringValidator, Validators, cache, cacheGroup, createField, db, defaultTTL, repoGroup, toType, _, _ref;
...
Model = (function() {
  function Model(dataDefine) {
    var body, camelCased, capitaliseFirstLetter, f, k, key, keyName, name, v, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    _fn = function(key, self) {
      return self['findBy' + capitaliseFirstLetter(camelCased(key.name))] = function(v) {
