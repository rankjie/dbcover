...
Model = (function() {
  function Model(dataDefine) {
    var body, f, k, key, keyName, name, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    for (_l = 0, _len3 = _ref6.length; _l < _len3; _l++) {
      key = _ref6[_l];
      Model.prototype['findBy_' + key.name] = function(values) {
        var sqlStr, _len4, _m, _ref7;
        ...
        for (_m = 0, _len4 = _ref7.length; _m < _len4; _m++) {
          name = _ref7[_m];
          sqlStr.push("" + this.$nameToField[name].column + " = " + values[name]);
        }
        console.log('findBy产生的sql条件：' + sqlStr.join(' AND '));
        return this.find(sqlStr.join(' AND ')).first();
      };
    }
  }
